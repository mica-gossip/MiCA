...
public class DemoNaiveBroadcast {
    ...
    /**
     * This createNodeFunc is used by the test harness to create individual node
     * instances.
     * 
     * F3 is a fancy way of creating a callable object that can be passed as a
     * parameter to the test harness. The f() function is what's important.
     * 
     * 
     */
