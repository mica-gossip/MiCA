...
public class ListMapRow<Key,T> implements List<T> {
	...
	private Key key = null;  // this listmaprow corresponds to the "key" entry of lm
	...
	public boolean add(T arg0) {
		...
		// ListMap must be the same length.  To change the length, one must add or
	...
	public boolean contains(Object arg) {
		// This is a read-only or modify-in-place operation, so could be implemented. 
		// However, it is not in the critical path, so it has been left as a stub.
		throw new UnsupportedOperationException();
	}
	...
	/**
	 * Get the column entries as a list.  Modifying this list will NOT affect the underlying ListMap, so it should be
