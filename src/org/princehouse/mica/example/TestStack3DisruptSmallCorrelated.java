 ...
 *
 */
public class TestStack3DisruptSmallCorrelated extends TestHarness<MergeCorrelated> {
	...
	public static void main(String[] args) {
		...
		final TestStack3DisruptSmallCorrelated harness = new TestStack3DisruptSmallCorrelated();
