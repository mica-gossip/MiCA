...
public class DemoPipeline {
	public static class DemoStack extends MergeCorrelated {
		 ...
		 */
		public DemoStack(Overlay view, int nodeID) {
			super();
	 ...
	 * 
	 */
	public static F3<Integer, Address, List<Address>, Pipeline<DemoStack>> createNodeFunc = new F3<Integer, Address, List<Address>, Pipeline<DemoStack>>() {
		@Override
		public Pipeline<DemoStack> f(Integer i, Address address,
			...
			return new Pipeline<DemoStack>(5, new ProtocolFactory<DemoStack>() {
				@Override
				public DemoStack createProtocol() {
					return new DemoStack(view, j);
				}
			});
		}
	};
