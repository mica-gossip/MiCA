...
/**
 * Merge two protocols so that they make independent gossip choices. Individual
 * subprotocol select distributions are preserved. Merged rate is <= sum of the
 * rates of the two subprotocols.
 * 
 * @author lonnie
 * 
 */
