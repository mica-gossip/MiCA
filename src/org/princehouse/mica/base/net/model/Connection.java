...
/**
 * Connections provide an implementation-independent mechanism for streaming
 * data to/from a remote node.
 * 
 * @author lonnie
 * 
 */
public abstract class Connection {
    ...
    /**
     * Close the connection. Note that the output stream may need to be flushed
     * first.
     * 
     * @throws IOException
     */
