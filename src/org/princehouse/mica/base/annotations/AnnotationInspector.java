...
public class AnnotationInspector {
	public static Method locateUpdateMethod(Class<?> pclass) throws TooManyException,
			NotFoundException {
		// TODO sanity check that update has the right signature
		try {
			return Functional.findExactlyOne(
	...
	public static Method locateFrequencyMethod(Class<?> pclass) throws TooManyException,
			NotFoundException {
