...
public interface CommunicationPatternAgent {
     ...
     * @return
     */
    public abstract Serializable f1(MicaRuntime initiatorRuntime) throws MicaException;
    ...
    // public abstract void sendObject(Serializable obj, OutputStream out)
    // throws FatalErrorHalt, AbortRound;

    // public abstract Serializable recvObject(InputStream in) throws
