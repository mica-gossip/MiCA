...
public abstract class ProxyBase implements Serializable {
    ...
    /**
     * Transition a wrapped object back into the object itself. With throw an
     * exception if called on an actual proxy
     * 
     * @return
     */
    public Object unbox() {
    ...
    // package a target for proxying. this function will be implemented by the
    // proxy class generator
    public abstract void box(Object target);

    // copy changed values back to the original object. this function will be
    // implemented by the proxy class generator
