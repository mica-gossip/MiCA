...
public class ExclusiveFieldSerializer<T> extends Serializer<T> implements Comparator<ExclusiveFieldSerializer.CachedField> {
	final Kryo kryo;
	final Class type;
	...
	public ExclusiveFieldSerializer (Kryo kryo, Class type) {
		this.kryo = kryo;
		this.type = type;
		rebuildCachedFields();
	}
	...
	// ljp --- look at this mechanism for exclusive field serialization
	...
	// ljp -- just have to sabotage this.fields in order to exclude fields!
	...
	abstract class AsmCachedField extends CachedField {
		FieldAccess access = (FieldAccess)ExclusiveFieldSerializer.this.access;
	}
