...
public class Distribution<T> extends HashMap<T, Double> {
     ...
     * In-place "bump"
     * 
     * Add delta to the value associated with the given key; adjust other values
     * to keep the distribution normalized.
     * 
     * @param key
     * @param delta
     * @return
    ...
    /**
     * Return a uniform distribution over the elements of collection c. Note
     * that if c contains duplicate elements, they will have a correspondingly
     * increased share of probability
     * 
     * @param c
     * @return
     */
    ...
    /**
     * Create a singleton distribution (That is, dist[key] == 1, dist[x] = 0 for
     * x != key)
     * 
     * @param key
     * @return
    ...
    /**
     * Returns true if this distribution sums to one, within MAGNITUDE_EPS
     * tolerance
     * 
     * @return
     */
