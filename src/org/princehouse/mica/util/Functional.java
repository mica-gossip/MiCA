...
public class Functional {
     ...
     * @return
     */
    public static <C extends Collection<T>, T, S extends T> C extend(C collection, Iterable<S> iterable) {
        for (T q : iterable) {
            collection.add(q);
        }
        return collection;
    ...
    public static <T> T findExactlyOne(Iterable<T> objects, F<T, Boolean> f) throws TooManyException, NotFoundException {
