...
public class TestC1ProtocolProxyJava {
	...
	public static void main(String[] args) {
		...
		System.out.println(String.format(
				"test proxy field box+set output value (expect 1000) = %d\n",
				proxy.getfield3()));
		
		proxy.setfield3(13);
		System.out.println(String.format(
				"test proxy field get/set output value (expect 13) = %d\n",
				proxy.getfield3()));
		...
		b.y = 23;
		System.out.println(String.format(
				"test nonproxy field get output value (expect 23) = %d\n",
				nonproxy.getfield3()));

		nonproxy.setfield3(11);
		System.out
				.println(String
						.format("test nonproxy field set output value (expect 11) = %d\n",
								b.y));
