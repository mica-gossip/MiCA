 ...
 * 
 */
public class DilationGrowthCompleteD3 extends TestHarness implements ProtocolInstanceFactory {
    ...
    public static void main(String[] args) {
        for (int i = 0; i < experiments; i++) {
            DilationGrowthCompleteD3 test = new DilationGrowthCompleteD3(i);
            test.runMain(args);
        }
    }
    ...
    public DilationGrowthCompleteD3(int i) {
        this.i = i;
    }
