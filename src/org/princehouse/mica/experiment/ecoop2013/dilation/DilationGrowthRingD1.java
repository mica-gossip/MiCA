 ...
 * 
 */
public class DilationGrowthRingD1 extends TestHarness implements ProtocolInstanceFactory {
    ...
    public static void main(String[] args) {
        for (int i = 0; i < experiments; i++) {
            DilationGrowthRingD1 test = new DilationGrowthRingD1(i);
            test.runMain(args);
        }
    }
    ...
    public DilationGrowthRingD1(int i) {
        this.i = i;
    }
