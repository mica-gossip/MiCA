 ...
 * 
 */
public class DilationGrowthR4D0 extends TestHarness implements ProtocolInstanceFactory {
    ...
    public static void main(String[] args) {
        for (int i = 0; i < experiments; i++) {
            DilationGrowthR4D0 test = new DilationGrowthR4D0(i);
            test.runMain(args);
        }
    }
    ...
    public DilationGrowthR4D0(int i) {
        this.i = i;
    }
