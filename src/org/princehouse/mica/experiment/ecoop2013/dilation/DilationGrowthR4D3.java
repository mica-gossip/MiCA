 ...
 * 
 */
public class DilationGrowthR4D3 extends TestHarness implements ProtocolInstanceFactory {
    ...
    public static void main(String[] args) {
        for (int i = 0; i < experiments; i++) {
            DilationGrowthR4D3 test = new DilationGrowthR4D3(i);
            test.runMain(args);
        }
    }
    ...
    public DilationGrowthR4D3(int i) {
        this.i = i;
    }
