 ...
 * 
 */
public class DilationGrowthR4D1 extends TestHarness implements ProtocolInstanceFactory {
    ...
    public static void main(String[] args) {
        for (int i = 0; i < experiments; i++) {
            DilationGrowthR4D1 test = new DilationGrowthR4D1(i);
            test.runMain(args);
        }
    }
    ...
    public DilationGrowthR4D1(int i) {
        this.i = i;
    }
