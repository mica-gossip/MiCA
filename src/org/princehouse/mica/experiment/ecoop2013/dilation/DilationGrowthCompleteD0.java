 ...
 * 
 */
public class DilationGrowthCompleteD0 extends TestHarness implements ProtocolInstanceFactory {
    ...
    public static void main(String[] args) {
        for (int i = 0; i < experiments; i++) {
            DilationGrowthCompleteD0 test = new DilationGrowthCompleteD0(i);
            test.runMain(args);
        }
    }
    ...
    public DilationGrowthCompleteD0(int i) {
        this.i = i;
    }
