...
public class Pipeline<P extends Protocol> extends BaseProtocol {
  ...
  /**
   * The ProtocolFactory is supplied to the Pipeline constructor. It tells the Pipeline how to
  ...
  /**
   * Called to create a new protocol instance to be added to the pipeline (by default, this calls
   * the factory method)
   */
  public P create() {
  ...
  public static abstract class ProtocolFactory<Q extends Protocol> {
    ...
    /**
     * Called immediately before a protocol is removed from the pipeline. Does nothing by default;
     * you don't need to override this if you're cool with having old protocols be garbage
     * collected.
     *
     * @param pinstance
     */
