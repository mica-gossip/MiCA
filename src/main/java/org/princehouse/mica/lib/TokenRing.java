...
/**
 * Dijkstra's first self-stabilizing token ring example. Moves a token around a ring
 * counter-clockwise (i.e., from successor to predecessor)
 * <p>
 * Override act() if you want the node to do something when it has the token.
 * <p>
 * Depends on several input services: ring, a SinglyLinkedRingOverlay leader, a LeaderElection
 * implementation networkSize, a NetworkSizeCounter implementation
 *
 * @author lonnie
 */
