...
/**
 * Merge two protocols so that they make independent gossip choices. Individual subprotocol select
 * distributions are preserved. Merged rate is <= sum of the rates of the two subprotocols.
 *
 * @author lonnie
 */
public class MergeIndependent extends Merge {
  ...
  /**
   * Convenient static method for merging p1+p2. Same as "new MergeIndependent(p1,p2)"
   *
   * @param p1
   * @param p2
   * @return
