...
// FIXME  currently just a copy of merge correlated
...
public class MergeShuffle extends Merge {
     ...
     *            Second subprotocol
     */
    public MergeShuffle(Protocol p1, Protocol p2) {
        super(p1, p2);
    }
    ...
    /**
     * Composite gossip rate; less than or equal to the sum of the subprotocol
     * rates
     * 
     * @return
     */
    ...
    public Distribution<MergeSelectionCase> decideSelectionCase(Address x) {
        ...
        if (p1 <= Distribution.MAGNITUDE_EPS && p2 <= Distribution.MAGNITUDE_EPS) {
            System.err.printf("Broken component distribution diagnostic for x=%s: p1=%s=%s %s, p2=d2=%s %s\n", x,
                    getP1().getClass(), p1, (d1.containsKey(x) ? "" : "(MISSING)"), getP2().getClass(), p2,
    ...
    /**
     * Convenience static method for merging. Same as
     * "new MergeCorrelated(p1,p2)"
     * 
     * @param p1
     * @param p2
     * @return
     */
    public static MergeShuffle merge(Protocol p1, Protocol p2) {
