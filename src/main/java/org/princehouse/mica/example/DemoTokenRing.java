...
public class DemoTokenRing extends TestHarness implements ProtocolInstanceFactory {
  ...
  /**
   * Override the act() function of TokenRing to print a message to the console when the token
   * arrives.
   *
   * @author lonnie
   */
  public static class ChattyTokenRing extends TokenRing {
    ...
    public ChattyTokenRing(SinglyLinkedRingOverlay overlay, LeaderElection leader,
        NetworkSizeCounter size,
        String msg) {
