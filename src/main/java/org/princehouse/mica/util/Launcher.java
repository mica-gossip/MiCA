 ...
 * <p>
 * Command line arguments can be passed to the protocol using JCommander for parsing.  To do this,
 * mark up your Protocol class with JCommander's @Parameter annotations.
 *
 * @author lonnie
 */
public class Launcher {
   ...
   * <p>
   * Launch a single instance of a MiCA protocol. The protocol can be passed command line parameters
   * by annotating it with JCommander \@Parameter tags; for an example, see
   * <p>
   * Protocols launched this way must have a default constructor. If a method named "initialize",
   * taking no parameters, exists, it will be called on the protocol instance after command line
  ...
  private void runMain(String[] args) {
    ...
    try {
      ...
      fail("Illegal accesss exception: Is the default constructor for %s public?",
          protocolClassString);
    }
    ...
    SimpleRuntime
        .launch(new SimpleRuntime(address), protocolInstance, false, intervalMS, randomSeed,
            timeout);
  }
