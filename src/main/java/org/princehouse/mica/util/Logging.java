...
public class Logging {
  ...
  /**
   * Returns a "filename:lineno" string for the location in the call stack corresponding to framesUp
   * frames above the call site. framesUp == 0 corresponds with the location invoking
   * getCodeLocation, 1 is the callsite of that function, etc.
   *
   * @param framesUp
   * @return
   */
