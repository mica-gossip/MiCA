...
/**
 * Applies the @Select annotation to an object to produce a
 * Distribution<Address>
 * 
 * Applicable object types: Distribution<Address> Protocol Overlay Collection
 * (returns uniform random distribution)
 * 
 * @author lonnie
 * 
 * @param
