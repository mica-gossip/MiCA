...
public abstract class Selector {
  ...
  public static Distribution<Address> asDistribution(Object obj, RuntimeState rts)
  ...
  protected static Collection<Address> getCollectionFromValue(Object value, RuntimeState rts)
    ...
    if (value instanceof Collection) {
      ...
      throw new RuntimeException(
          String.format("Don't know how to extract view from %s instance", value
              .getClass().getName()));
    }
  }
  ...
  public static abstract class SelectorAnnotationDecider {
    ...
    public abstract <P extends Protocol> Selector getSelector(AnnotatedElement element)
        throws SelectException;
  ...
  public static class SelectDecider extends SelectorAnnotationDecider {
    ...
    public <P extends Protocol> Selector getSelector(AnnotatedElement element)
        throws InvalidSelectElement {
  ...
  public static List<SelectorAnnotationDecider> registeredDeciders = Functional
      .list(new SelectorAnnotationDecider[]{
