...
class SimpleRuntimeAgent extends RuntimeAgent {
  ...
  /**
   * Utility class representing the message sent by the gossip initiator to the gossip receiver.
   * RequestMessage instances are serialized and sent over the network.
   *
   * @param Top-level protocol class
   * @author lonnie
   */
  ...
  /**
   * Utility class representing the response message sent by the gossip receiver to the initiator
   * after receiving a RequestMessage. ResponseMessages are serialized and sent over the network.
   *
   * @param Top-level Protocol class
   * @author lonnie
   */
  ...
  /**
   * Initialize Runtime Agent, including searching for select, update, rate annotated elements.
   *
  ...
  /**
   * Callback executed when a gossip request arrives. Deserializes a RequestMessage from the
   * incoming connection and sends back a ResponseMessage.
   * <p>
   * receiverState is modified in-place by the update method; for this reason, setProtocolInstance
   * is never called
   *
   * @param runtime    Current Runtime
   * @param receiver   Protocol instance
   * @param connection
   * @throws IOException
   * @throws AbortRound
   * @throws FatalErrorHalt
   */
  public void acceptConnection(MicaRuntime runtime, Protocol receiver, Connection connection)
      throws IOException,
