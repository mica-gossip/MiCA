...
public class FakeCompiler extends Compiler {
    ...
    public static class FakeCommunicationPatternAgent implements CommunicationPatternAgent {
        ...
        @Override
        public Serializable f2(MicaRuntime receiverRuntime, Serializable m1) throws FatalErrorHalt, AbortRound {
        ...
        @Override
        public void f3(MicaRuntime initiatorRuntime, Serializable m2) throws FatalErrorHalt, AbortRound {
            // do nothing
        }
