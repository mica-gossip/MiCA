...
public class AnnotationInspector {
  ...
  public static Method locateUpdateMethod(Class<?> pclass)
  ...
  public static Method locateFrequencyMethod(Class<?> pclass)
      throws TooManyException, NotFoundException {
  ...
  public static Selector locateSelectMethod(Class<?> klass)
      throws NotFoundException, TooManyException,
      SelectException {
    /*
