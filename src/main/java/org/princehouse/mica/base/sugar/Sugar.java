...
public class Sugar {
  ...
  private Selector getSelector(Protocol p)
      throws NotFoundException, TooManyException, SelectException {
    Class<?> k = p.getClass();
  ...
  private Method getRateMethod(Protocol p) throws TooManyException, NotFoundException {
    Class<?> k = p.getClass();
