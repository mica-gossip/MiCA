 ...
 * may wish to cache the resulting agent after executing compile() once for a
 * given Protocol class T.
 * 
 * @author lonnie
 * 
 */
public abstract class Compiler {
     ...
     * @param pinstance
     *            Protocol instance
     * @return A RuntimeAgent. Static analysis-based agents may be reused for
     *         any protocol instance of the given class.
     */
